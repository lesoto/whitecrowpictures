class CreatePhotographers < ActiveRecord::Migration
  def self.up
    create_table :photographers do |t|
      ...
      t.string    :current_login_ip,    :limit => 50                  # optional, see Authlogic::Session::MagicColumns
      t.string    :last_login_ip,       :limit => 50                  # optional, see Authlogic::Session::MagicColumns
